 ...
 */
#define E0_AUTO_FAN_PIN   FAN1_PIN //PC7//-1  //PC7
 ...
 */
#define DEFAULT_STEPPER_TIMEOUT_SEC (5*60)  //120
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN             -1 //44 // Pin to detect power-loss. Set to -1 to disable default pin on boards without module, or comment to use board default.
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.46 }    // (mm) Compression length per 1mm/s extruder speed, per extruder. Override with 'M900 T<tool> K<mm>'.
  #else
    #define ADVANCE_K 0.46        // (mm) Compression length for all extruders. Override with 'M900 K<mm>'.
  #endif
...
#define BUFSIZE 32    // Advanced OK B value
 ...
 */
#define TX_BUFFER_SIZE 32 //128 //0
 ...
 */
  ...
  #define HOLD_MULTIPLIER    0.01  // Scales down the holding current from run current
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_3_DESC "Heat Bed/Home/Level"
  ...
  #define MAIN_MENU_ITEM_5_DESC "UBL set & Activate"
