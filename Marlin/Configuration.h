...
//#define USE_ZMIN_PLUG  //Using Probe instead, Allowing  switch to be disconnected
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -56.4, -14.6, -1.6 } //-1.473 } //-1.2 }
...
#define Z_PROBE_FEEDRATE_FAST (8*60)  //was Z_PROBE_SPEED_FAST
