...
#define STRING_CONFIG_H_AUTHOR "(Autonumous, Ender-3 Pro)" // Original author or contributor.
...
#define MACHINE_UUID "7c23144f-cb56-47f4-b7bc-97cdc8ac60c0"
...
#define PIDTEMPBED
  ...
  //#define DEFAULT_BED_KD 305.4
    // my values
  #define DEFAULT_BED_KP 103.6972 //45.3
  #define DEFAULT_BED_KI 17.9640 //7.54
  #define DEFAULT_BED_KD 399.0616 //181.7
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -56.4, -14.6, -1.7 } //-1.473 } //-1.2 }
...
#define XY_PROBE_FEEDRATE    (170*60) // (mm/min)
...
#define HOMING_FEEDRATE_MM_M { (150*60), (150*60), (20*60) } //{ (50*60), (50*60), (8*60) }
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 141.00  //282.8427124746
  ...
  #define SKEW_CORRECTION_FOR_Z
    ...
    #define XZ_DIAG_AC 141.4 //282.8427124746
    #define XZ_DIAG_BD 140.4//282.8427124746
